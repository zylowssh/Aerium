...
export default function CompactSensorSection() {
  ...
  return (
    <PinnedSection ref={sectionRef} zIndex={40}>
      ...
      >
        <img
          src="/sensor_closeup.jpg"
          alt="Aerium Compact Sensor"
      ...
      >
        <div className="headline-large text-[#0B0C10]">
          <div className="headline-line">COMPACT</div>
          <div className="headline-line">SENSOR</div>
      ...
      >
        Calibrated for accuracy. Small enough to blend into any room. Reliable
        enough to run 24/7.
      </p>
