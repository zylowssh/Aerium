...
const INJECTED_STYLES = `
  ...
  .text-silver-matte {
      color: color-mix(in srgb, hsl(var(--foreground)) 88%, white);
...
export function CinematicHero({ 
  brandName = "Aerium",
  tagline1 = "Voir chaque variation,",
  tagline2 = "agir avant l'alerte.",
  cardHeading = "Pilotage atmospherique continu.",
  cardDescription = <><span className="text-white font-semibold">Aerium</span> transforme les donnees de capteurs en actions claires pour maintenir une qualite d'air saine, heure apres heure.</>,
  metricValue = 742,
  metricLabel = "CO2 PPM LIVE",
  ctaHeading = "Passez de la mesure a l'action.",
  ctaDescription = "Surveillez, comparez et declenchez des recommandations en quelques secondes.",
  primaryCtaLabel = "Ouvrir le dashboard",
  primaryCtaHref = "/dashboard",
  secondaryCtaLabel = "Voir le code source",
  secondaryCtaHref = "https://github.com/zylowssh/Aerium",
  className, 
  ...props 
}: CinematicHeroProps) {
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href={primaryCtaHref} aria-label={primaryCtaLabel} className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            <div className="h-8 w-8 rounded-lg bg-slate-900 text-white flex items-center justify-center text-sm font-bold">
              A
            </div>
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-500 uppercase mb-[-2px]">Aerium</div>
              <div className="text-xl font-bold leading-none tracking-tight">{primaryCtaLabel}</div>
            </div>
          </a>
          <a href={secondaryCtaHref} aria-label={secondaryCtaLabel} className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background">
            <div className="h-8 w-8 rounded-lg bg-white/10 text-white flex items-center justify-center text-sm font-bold">
              G
            </div>
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-400 uppercase mb-[-2px]">Source</div>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-[0.85] lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Air Pulse</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">AQ</div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-blue-500/20 to-blue-900/10 flex items-center justify-center border border-blue-400/30 shadow-inner">
                    <span className="text-xs lg:text-sm font-bold text-white drop-shadow-lg" aria-hidden="true">CO2</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Capteur stable</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Zone B2 - 612 ppm</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-indigo-500/20 to-indigo-900/10 flex items-center justify-center border border-indigo-400/30 shadow-inner">
                    <span className="text-xs lg:text-sm font-bold text-white drop-shadow-lg" aria-hidden="true">ALR</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Alerte diffusee</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Ventilation recommandee</p>
                  </div>
                </div>
