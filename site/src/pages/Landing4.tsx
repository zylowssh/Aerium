...
export function CinematicHero({ 
  ...
  cardHeading = "Air intelligence, made actionable.",
  cardDescription = <><span className="text-white font-semibold">Aerium</span> turns live sensor data into clear actions to keep indoor air quality healthy throughout the day.</>,
  metricValue = 742,
  metricLabel = "CO2 ppm live",
  ctaHeading = "Take control of your air.",
  ctaDescription = "Monitor CO2, humidity, and temperature in real time, then act before comfort and safety degrade.",
  className, 
  ...props 
}: CinematicHeroProps) {
