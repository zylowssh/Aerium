...
export const tourSteps: TourStep[] = [
  ...
  // Analytics page steps
  {
    ...
    title: "Page Analyses 📊",
    content:
      "Explorez les tendances de qualité de l'air sur différentes périodes (24h, 7 jours, 30 jours).",
    placement: "bottom",
    page: "/analytics",
  },
  {
    ...
    content:
      "Visualisez les métriques CO₂, température et humidité avec des graphiques détaillés.",
    placement: "bottom",
    page: "/analytics",
  },
  {
    ...
    content:
      "Consultez les statistiques de qualité de l'air : temps optimal, pics de CO₂, et nombre de lectures.",
    placement: "top",
    page: "/analytics",
  },
  // Sensors page steps
  {
    ...
    content:
      "Gérez tous vos capteurs depuis cette page. Ajoutez, modifiez ou supprimez des capteurs.",
    placement: "bottom",
    page: "/sensors",
  },
  {
    ...
    content:
      "Consultez les données en temps réel de chaque capteur : CO₂, température, humidité et statut.",
    placement: "top",
    page: "/sensors",
  },
  {
    ...
    content:
      "Cliquez ici pour ajouter un capteur réel (MQ-135, SCD30, etc.) ou en mode simulation.",
    placement: "bottom",
    page: "/sensors",
  },
  {
