...
export default function HeroSection() {
  ...
  return (
    <PinnedSection ref={sectionRef} zIndex={10}>
      ...
      <p
        ref={subheadRef}
        className="subheadline absolute text-center text-secondary-light will-change-transform px-4"
        style={{ top: "88%", left: "50%", transform: "translateX(-50%)" }}
      >
        Aerium tracks CO2, humidity, and temperature in real time—so your spaces
