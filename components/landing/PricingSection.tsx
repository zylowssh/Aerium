...
export default function PricingSection() {
  ...
  const handlePreOrder = () => {
    setDialogContent({
      ...
      message:
        "Thank you for your interest in Aerium! Pre-orders will open soon. Sign up for our newsletter to be the first to know.",
    });
    setShowDialog(true);
  };
  ...
  const handleContactSales = () => {
    setDialogContent({
      title: "Contact Sales",
      message:
        "For fleet orders and enterprise inquiries, please email us at sales@aerium.io. We'll get back to you within 24 hours.",
    });
    setShowDialog(true);
  };
    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div ref={headerRef} className="text-center mb-12">
          <span className="mono-label text-primary mb-4 block">PRICING</span>
        ...
        <div ref={cardRef} className="flex justify-center mb-20">
          <div className="card-white w-full max-w-md p-8 md:p-10">
            ...
            <button onClick={handlePreOrder} className="btn-primary w-full mb-4">
              Pre-order now
        ...
        <footer ref={footerRef} className="border-t border-[#E5E7EB] pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <button
                onClick={() => {
                  setDialogContent({
                    ...
                    message:
                      "We take your privacy seriously. All data is encrypted and stored securely. You have full control over your data and can export or delete it at any time.",
                  });
                  setShowDialog(true);
                }}
              ...
              <button
                onClick={() => {
                  setDialogContent({
                    ...
                    message:
                      "By using Aerium, you agree to our terms of service. We provide a 30-day money-back guarantee and a 2-year warranty on all hardware.",
                  });
                  setShowDialog(true);
                }}
                className="footer-link text-sm text-[#6B7280] hover:text-[#0B0C10] transition-colors"
              ...
              <button
                onClick={() => {
                  setDialogContent({
                    title: "Support",
                    message:
                      "Our support team is available 24/7. Reach out to us at support@aerium.io or through our live chat.",
                  });
                  setShowDialog(true);
                }}
                className="footer-link text-sm text-[#6B7280] hover:text-[#0B0C10] transition-colors"
            ...
            <span className="mono-label text-[#6B7280]">© 2026 Aerium</span>
          </div>
        </footer>
      </div>
      ...
      {showDialog && (
        ...
        >
          ...
          >
            <h3 className="font-display text-xl font-semibold text-[#0B0C10] mb-3">
              {dialogContent.title}
            </h3>
            <p className="text-secondary-light mb-6">{dialogContent.message}</p>
            <button
              onClick={() => setShowDialog(false)}
